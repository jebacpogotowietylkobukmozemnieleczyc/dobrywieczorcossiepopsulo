...
public:
    Network() : callbackMap({{"si", [&](std::vector<std::shared_ptr<User> >::iterator &user,const std::vector<std::string> &x) { user = Login(x.at(0),x.at(1));if(user!=users.end())return "yes:;";return "no:;"; }},
                             ...
                             {"ct", [&](std::vector<std::shared_ptr<User> >::iterator &user,const std::vector<std::string> &x) {if(clashes.at((*user)->getClashId()).CheckTurn((*user)))return "yes:;";return "no;";}},
                             {"cr", [&](std::vector<std::shared_ptr<User> >::iterator &user,const std::vector<std::string> &x) {if(clashes.at((*user)->getClashId()).CheckRound(std::stoi(x.at(0))))return "yes:;";return "no;";}},
                             ...
                             {"ls", [&](std::vector<std::shared_ptr<User> >::iterator &user,const std::vector<std::string> &x) {DeleteClash(user);(*user)->Lose();return "yes:;";}},
                             {"wn", [&](std::vector<std::shared_ptr<User> >::iterator &user,const std::vector<std::string> &x) {DeleteClash(user);(*user)->Win();return "yes:;";}},
